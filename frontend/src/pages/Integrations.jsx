        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex gap-2">
            {status?.connected ? (
              ...
              <div className="flex gap-2">
                <button data-testid="autodesk-connect-demo-btn" disabled={connecting} onClick={async () => {
                  setConnecting(true);
                  try {
                  ...
                  className="h-10 px-4 rounded-md bg-emerald-600 text-white text-sm font-medium hover:bg-emerald-700 disabled:opacity-50 flex items-center gap-2">
                  <CheckCircle2 size={14} /> Connect Forma (1-Click)
                </button>
                <button data-testid="autodesk-connect-btn" disabled={connecting || !status?.configured} onClick={connect}
                  className="h-10 px-4 rounded-md bg-slate-900 text-white text-sm font-medium hover:bg-slate-800 disabled:opacity-50 flex items-center gap-2">
                  {connecting ? <Loader2 size={14} className="animate-spin" /> : <Link2 size={14} />} Live OAuth
                </button>
              </div>
            )}
          </div>
