      ...
      <div className="hidden lg:block relative bg-slate-900 overflow-hidden">
        ...
        <div className="relative h-full p-12 flex flex-col justify-between text-white">
          <Link to="/" className="flex items-center gap-3">
            <img src={brandLogo} alt="SmartScape Logo" className="w-11 h-11 object-contain drop-shadow-md shrink-0" />
            <div className="font-display font-extrabold text-xl">SmartScape</div>
          </Link>
          <div>
